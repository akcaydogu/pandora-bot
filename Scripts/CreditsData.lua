...
CreditsData =
{
	...
	{	
		...
		{ CreateScreenObstacle = "EndCreditsVignette", X = 0, Y = 540, SkipScreenAnchors = true },
		{ ScrollOn = true, ScrollSpeedOverride = 47, ScrollDistanceOverride = 4080 },
	...
	Return03 =
	{
		...
		{ Text = "InGameCredits_Cast_Marianne", Format = CreditsFormat.Craft },
		{ CreditLineBuffer = CreditSpacing.CreditLineBufferCraftToName },
		{ Text = "InGameCredits_Name_Marianne", Format = CreditsFormat.Name },
		{ CreditLineBuffer = CreditSpacing.CreditLineBufferScroll },
