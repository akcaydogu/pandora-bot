...
TraitData =
{
  ...
  BowConsecutiveBarrageTrait =
  {
	...
	{
		InheritFrom = { "ChaosBlessingTrait" },
		RequiredOneOfTraits =  { "ChaosBlessingTrapDamageTrait", "ChaosBlessingMeleeTrait", "ChaosBlessingRangedTrait", "ChaosBlessingAmmoTrait", "ChaosBlessingMaxHealthTrait", "ChaosBlessingBoonRarityTrait", "ChaosBlessingMoneyTrait", "ChaosBlessingMetapointTrait", "ChaosBlessingSecondaryTrait", "ChaosBlessingDashAttackTrait" },
		ChanceToPlay = 0.20,
		RarityLevels =
		{
			Legendary =
