DeathLoopData =
{
	DeathArea =
	{
		...
		DistanceTriggers =
		{
			...
			-- Nyx
			{
				TriggerObjectType = "NPC_Nyx_01", WithinDistance = 500, RequiredCompletedRuns = 0,
				TriggerOnceThisRun = true,
				VoiceLines =
				{
					{
					...
					},
					{
						...
						-- You have done well.
						{ Cue = "/VO/Nyx_0215", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- You broke free.
						{ Cue = "/VO/Nyx_0216", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- You reached the surface...
						{ Cue = "/VO/Nyx_0217" },
						-- Did you find her?
						{ Cue = "/VO/Nyx_0218", RequiredPlayed = { "/VO/Nyx_0217" }, RequiredFalseTextLines = { "Ending01" }, },
						-- Well done.
						{ Cue = "/VO/Nyx_0219", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- At last.
						{ Cue = "/VO/Nyx_0220", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- I never doubted you.
						{ Cue = "/VO/Nyx_0283", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- Excellently done.
						{ Cue = "/VO/Nyx_0285", RequiredPlayed = { "/VO/Nyx_0217" }, },
						-- I knew that you were more than capable.
						{ Cue = "/VO/Nyx_0282", RequiredPlayed = { "/VO/Nyx_0217" }, RequiredTextLines = { "Ending01" }, RequiredFalseTextLinesThisRun = { "Ending01" }, },
						...
						{ Cue = "/VO/Nyx_0286", RequiredPlayed = { "/VO/Nyx_0217" }, RequiredTextLines = { "Ending01" }, RequiredFalseTextLinesThisRun = { "Ending01" }, },
						-- Well done, child.
						{ Cue = "/VO/Nyx_0474", RequiredPlayed = { "/VO/Nyx_0217" }, RequiredTextLines = { "Ending01" }, RequiredFalseTextLinesThisRun = { "Ending01" }, },
						-- A commendable result.
						{ Cue = "/VO/Nyx_0475", RequiredPlayed = { "/VO/Nyx_0217" } },
						-- You have done well.
						{ Cue = "/VO/Nyx_0476", RequiredPlayed = { "/VO/Nyx_0217" } },
						-- Excellent work.
						{ Cue = "/VO/Nyx_0477", RequiredPlayed = { "/VO/Nyx_0217" } },
						-- To your continued success.
						{ Cue = "/VO/Nyx_0478", RequiredPlayed = { "/VO/Nyx_0217" } },
					},
					{
						BreakIfPlayed = true,
						RandomRemaining = true,
						...
						-- The realm is strong.
						{ Cue = "/VO/Nyx_0479", RequiredPlayed = { "/VO/Nyx_0217" }, RequiredTextLines = { "Ending01" }, RequiredFalseTextLinesThisRun = { "Ending01" }, },
						-- The House is in order.
						{ Cue = "/VO/Nyx_0480", RequiredTextLines = { "Ending01" }, RequiredFalseTextLinesThisRun = { "Ending01" }, },
						-- Haaaaah.
						-- { Cue = "/VO/Nyx_0053" },
						-- A welcome sight.
						-- { Cue = "/VO/Nyx_0056" },
				...
				{
					{
						...
						-- Hello my friend.
						{ Cue = "/VO/Orpheus_0093", RequiredPlayed = { "/VO/Orpheus_0061" }, },
						-- Hello friend.
						{ Cue = "/VO/Orpheus_0094", RequiredPlayed = { "/VO/Orpheus_0061" }, },
						-- Greetings.
		...
		InspectPoints =
		{
			...
			[556919] =
			{
				PlayOnce = true,
				UseText = "UseExamineMisc",
				RequiredTextLines = { "OlympianReunionQuestComplete", "DONTWORK" },
				InteractTextLineSets =
				{
						...
						{
							{
								...
								UsePlayerSource = true,
								RequiredMinElapsedTime = 3,
								-- Lord Hephaestus couldn't make the feast but he made us this!
								{ Cue = "/VO/ZagreusHome_3721" },
							},
						},
						{ Cue = "/VO/Storyteller_0413",
						...
						{
							{
								...
								{ Cue = "/VO/ZagreusHome_3722", RequiredAnyQueuedTextLines = GameData.GardenTextLines },
							},
						},
					},
				}
	...
	DeathAreaBedroom =
	{
		...
		StartUnthreadedEvents =
		{
							...
							TextLineSet =
							{
								MegaeraBedroom02 =
								{
									...
									{ Cue = "/VO/ZagreusHome_1354", Portrait = "Portrait_Zag_Empathetic_01", Speaker = "CharProtag",
										Text = "Meg...! She... {#DialougeItalicFormat}ah{#PreviousFormat}." },
								},
							},
						},
					},
										...
										{
											{
												...
												{ Cue = "/VO/ZagreusHome_2804", Portrait = "Portrait_Zag_Default_01", Speaker = "CharProtag",
													...
													PreLineWait = 0.35,
													Text = "...I thought you'd never ask. But I am glad you did." },
												-- intermission
			...
			-- Meg + Thanatos (Bedroom) / max relationship
			{
				...
				GameStateRequirements =
				{
					...
					RequiredAnyEncountersThisRun = { "ThanatosTartarus", "ThanatosAsphodel", "ThanatosElysium" },
							...
							TextLineSet =
							{
								MegaeraWithThanatosBedroom01 =
								{
									...
									{ Cue = "/VO/ZagreusHome_1517", Portrait = "Portrait_Zag_Empathetic_01", Speaker = "CharProtag",
										...
										PostLineAnim = "ZagreusTalkEmpathy_Return", PostLineAnimTarget = "Hero",
										-- Emote = "PortraitEmoteSurprise",
										Text = "Erm, Meg, Than, what... what are you two... what's going on? Whatever it is, I can explain, or... wait, you're both smiling. Oh... let me just... take this in a moment here." },
				...
				InteractTextLineSets =
				{
					InspectBedroom_TrojanArms =
					{
						...
						{ Cue = "/VO/Storyteller_0191",
							Text = "{#DialogueItalicFormat}The shattered weapons of the siege of Illion are now reduced to window-dressings in the Prince's ever-cluttered lair." },
		...
		EnteredVoiceLines =
		{
			...
			{ Cue = "/VO/ZagreusHome_0461", RequiredCompletedRuns = 0, RequiredPlayed = { "/VO/ZagreusHome_0458", "/VO/ZagreusHome_1522" }, PreLineWait = 0.35, BreakIfPlayed = true, PlayOnce = true, },
			-- Hey Room, I'm back.
			...
			{ Cue = "/VO/ZagreusHome_1055", PlayOnce = true, BreakIfPlayed = true, PreLineWait = 0.65, RequiredMinShrinePointThresholdClear = 0, RequiredPlayed = { "/VO/ZagreusHome_0588" }, RequiredFalsePlayed = { "/VO/ZagreusHome_1056", "/VO/ZagreusHome_1057", "/VO/ZagreusHome_1126" }, RequiredFalseCosmetics = { "QuestLog" }, AreIdsNotAlive = { 422255, 422142, }, },
			{
				...
				-- I'm back, Room, did you miss me?
				{ Cue = "/VO/ZagreusHome_0045", RequiredMinCompletedRuns = 4 },
				-- Gods...
				{ Cue = "/VO/ZagreusHome_0046" },
			},
		},
	},
...
GlobalVoiceLines.EnteredDeathAreaVoiceLines =
{
	...
	-- Killed during Thanatos Encounter
	{
		...
		BreakIfPlayed = true,
		PreLineWait = 2.25,
		RequiredAnyDeathEncounters = { "ThanatosTartarus", "ThanatosAsphodel", "ThanatosElysium" },
		SuccessiveChanceToPlayAll = 0.5,
		Queue = "Always",
	...
	{
		{
			...
			{ Cue = "/VO/ZagreusHome_3563", RequiredWeapon = "SwordWeapon", RequiredLastInteractedWeaponUpgrade = "SwordConsecrationTrait" },
			-- The pure essence of Celestial Sharanga...
			{ Cue = "/VO/ZagreusHome_3566", RequiredWeapon = "BowWeapon", RequiredLastInteractedWeaponUpgrade = "BowBondTrait" },
			-- The true strength of Naegling's Board...
			{ Cue = "/VO/ZagreusHome_3565", RequiredWeapon = "ShieldWeapon", RequiredLastInteractedWeaponUpgrade = "ShieldLoadAmmoTrait" },
			-- The sheer bloodthirst of the Frost Fair Blade...
			{ Cue = "/VO/ZagreusHome_3564", RequiredWeapon = "SpearWeapon", RequiredLastInteractedWeaponUpgrade = "SpearSpinTravel" },
			-- The raw savagery of the Claws of Enkidu...
			{ Cue = "/VO/ZagreusHome_3567", RequiredWeapon = "FistWeapon", RequiredLastInteractedWeaponUpgrade = "FistDetonateTrait" },
			-- The infernal fury of Igneus Eden...
			{ Cue = "/VO/ZagreusHome_3568", RequiredWeapon = "GunWeapon", RequiredLastInteractedWeaponUpgrade = "GunLoadedGrenadeTrait" },
		},
		{
			RandomRemaining = true,
			BreakIfPlayed = true,
