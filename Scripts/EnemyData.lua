UnitSetData.Enemies =
{
	...
	BaseThug =
	{
		...
		EnemySightedVoiceLines =
		{
			...
			RequiredFalseEncounters = { "DevotionTestTartarus", "DevotionTestAsphodel", "DevotionTestElysium", "ThanatosTartarus", "ThanatosAsphodel", "ThanatosElysium", "PerfectClearShrinePointChallenge" },
			Cooldowns =
			{
  ...
  DusaSummon =
  {
	...
	BaseSatyr =
	{
		...
		EnemySightedVoiceLines =
		{
			...
			RequiredFalseEncounters = { "DevotionTestTartarus", "DevotionTestAsphodel", "DevotionTestElysium", "ThanatosTartarus", "ThanatosAsphodel", "ThanatosElysium" },
			Cooldowns =
			{
				{ Name = "CombatBeginsLinesPlayedRecently", Time = 300 },
			},
	...
	TrainingMelee =
	{
		...
		InteractTextLineSets =
		{
			...
			SkellyAboutSources04 =
			{
				...
				{ Cue = "/VO/Skelly_0547",
					Emote = "PortraitEmoteSurprise",
					Text = "Oh! Yeah, now that you mention it, I guess that part of the old contract no longer applies. So you go right ahead! Appreciate you asking, pal." },
			},
			...
			SkellyTrueDeathQuest_Beginning_01 =
			{
				...
				{ Cue = "/VO/Skelly_0308",
					Text = "I am. And funny you should put it like that. Boyo, I am asking you to get me out of here. Permanently, if you catch my drift. This standing around stuff... just kind of wears on you, after a while, you know?" },
	...
	Harpy =
	{
		...
		BossPresentationSuperPriorityIntroTextLineSets =
		{
			...
			FurySisterUnionSingleSis01 =
			{
				PlayOnce = true,
				RequiredTextLines = { "FurySistersUnion01" },
				RequiredFalseTextLines = { "FurySisterUnionSingleSis02" },
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 1 },
			...
			FurySisterUnionSingleSis02 =
			{
				...
				RequiredFalseTextLines = { "FurySisterUnionSingleSis01" },
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 1 },
				RequiredMaxSupportAINames = 1,
	...
	Theseus =
	{
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			{
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				MinRunsSinceAnyTextLines = { TextLines = { "TheseusMiscStart23", "TheseusMiscStart23_B" }, Count = 10 },
			...
			{
				RequiredMinActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 3 },
				MinRunsSinceAnyTextLines = { TextLines = { "TheseusMiscStart23", "TheseusMiscStart23_B" }, Count = 15 },
			...
			{
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				MinRunsSinceAnyTextLines = { TextLines = { "TheseusMiscStart24", "TheseusMiscStart24_B" }, Count = 15 },
			...
			{
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				MinRunsSinceAnyTextLines = { TextLines = { "TheseusMiscStart25", "TheseusMiscStart25_B" }, Count = 15 },
			...
			{
				RequiredMaxActiveMetaUpgradeLevel = { Name = "BossDifficultyShrineUpgrade", Count = 2 },
				MinRunsSinceAnyTextLines = { TextLines = { "TheseusMiscStart26", "TheseusMiscStart26_B" }, Count = 15 },
	...
	Minotaur =
	{
		...
		BossPresentationIntroTextLineSets =
		{
			MinotaurFirstAppearance_NotMetTheseus =
			{
				...
				{ Cue = "/VO/ZagreusField_1747", Portrait = "Portrait_Zag_Defiant_01", Speaker = "CharProtag",
					PreLineAnim = "ZagreusTalkEmpathyStart", PreLineAnimTarget = "Hero",
					PostLineAnim = "ZagreusTalkEmpathy_Return", PostLineAnimTarget = "Hero",
	...
	Hades =
	{
		...
		BossPresentationSuperPriorityIntroTextLineSets =
		{
			...
			LordHadesAboutPersephoneMeeting07 =
			{
				...
				{ Cue = "/VO/ZagreusField_3684", Portrait = "Portrait_Zag_Defiant_01", Speaker = "CharProtag",
					...
					PostLineAnim = "ZagreusTalkDenialReturnToIdle", PostLineAnimTarget = "Hero",
					Emote = "PortraitEmoteFiredUp",
					Text = "Oh, what would you even know?! You claim so much respect for her, yet you didn't even respect her enough tell her what happened after she left! But... what am I saying... I know you love her, still, Father. That best explains all the terrible choices you've made." },
		...
		BossPresentationRepeatableTextLineSets =
		{
			...
			{
				RequiredWeapon = "FistWeapon",
				RequiredPlayed = { "LordHadesMiscStart19" },
	...
	Charon =
	{
		...
		BossPresentationOutroTextLineSets =
		{
			...
			BossCharonHermesQuestComplete01 =
			{
				PlayOnce = true,
				RequiredTextLines = { "HermesBeatCharonQuest01" },
				ConsecutiveClearsOfRoom = { Name = "CharonFight01", Count = 2 },
