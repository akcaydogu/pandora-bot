		...
		{
			{
				...
				{ Cue = "/VO/ZagreusField_0887", RequiredPlayed = { "/VO/ZagreusField_0888" }, },
	...
	RoomOpening =
	{
		...
		EnterVoiceLines =
		{
			...
			-- { Cue = "/VO/ZagreusScratch_0002b", RequiredCompletedRuns = 0, BreakIfPlayed = true, RequiredFalseFlags = { "KioskMode" }, },
			{
				...
				{ Cue = "/VO/ZagreusField_0007", RequiredLastLinePlayed = { "/VO/Hades_0066" }, RequiredFalseTextLines = { "Ending01" } },
				...
				{ Cue = "/VO/ZagreusField_0565", RequiredLastLinePlayed = { "/VO/Hades_0201" }, },
				...
				-- The power of Night.
				{ Cue = "/VO/ZagreusHome_2109", RequiredLastLinePlayed = { "/VO/Hades_0841" }, RequiredFalseTextLines = { "Ending01" }, },
				...
				InteractTextLineSets =
				{
					OpeningProcGenHint =
					{
						...
						{ Cue = "/VO/Storyteller_0154",
							Text = "{#DialogueItalicFormat}Each time the Prince delves back into the Underworld, its ever-shifting chambers realign to frustrate his attempts to maybe map it out." },
					},
				},
			},
		},
