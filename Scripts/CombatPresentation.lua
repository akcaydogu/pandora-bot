...
function HadesPhaseTransition(boss, currentRun, aiStage)
	...
	if boss.CurrentPhase == 2 and boss.Phase3ActivateGroups ~= nil then
		...
		SetAlpha({ Names = boss.Phase3ActivateGroups, Fraction = 0.0 })
		SetAlpha({ Names = boss.Phase3ActivateGroups, Fraction = 1.0, Duration = 0.3 })
	end
	if boss.CurrentPhase == 2 and boss.Phase3DeactivateGroups ~= nil then
		SetAlpha({ Names = boss.Phase3DeactivateGroups, Fraction = 0.0, Duration = 0.3 })
	end
	...
	if boss.CurrentPhase == 2 then
		SetAlpha({ Name = "Terrain_Lighting_01", Fraction = 0, Duration = 1.0 })
...
function HadesKillPresentation( unit, args )
	...
	SetAlpha({ Name = "Terrain_Lighting_01", Fraction = 1.0, Duration = 1.0 })
