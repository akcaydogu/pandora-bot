...
function ShowAwardMenu()
	...
	components.LevelProgress = CreateScreenComponent({ Name = "BlankObstacle", X = descriptionStartX, Y = descriptionStartY + 380, Group = "Combat_Menu" })
	...
	components.Sticker = CreateScreenComponent({ Name = "BlankObstacle", X = descriptionStartX + 230, Y = descriptionStartY + 700, Group = "Combat_Menu_Additive" })
...
function HandleUpgradeToggle( screen, button )
	local upgradeName = button.Data.Gift
